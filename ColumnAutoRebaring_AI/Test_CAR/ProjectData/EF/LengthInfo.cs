...
namespace Test_CAR
{
    public class LengthInfo
    {
        ...
        public int ImplantValue
        {
            get
            {
                return End - Singleton.Instance.OtherData.DesignInformations[IDColumn + 1].BottomTrue + Singleton.Instance.OtherData.DesignInformations[IDColumn + 1].ImplantLength;
            }
        }
        ...
        public string DiameterName { get { return Singleton.Instance.OtherData.DesignInformations[IDColumn].DiameterName; } }
    ...
    {
        private List<int> Location1s = new List<int>() { Singleton.Instance.OtherData.GeneralInfomation.StartOffset.Offset1 - Singleton.Instance.OtherData.DesignInformations[0].DevelopmentLength };
        private List<int> Location2s = new List<int>() { Singleton.Instance.OtherData.GeneralInfomation.StartOffset.Offset2 - Singleton.Instance.OtherData.DesignInformations[0].DevelopmentLength };
        ...
        public LengthInfoCollection(string id, bool isFromDatabase = false)
        {
            ...
            for (int i = 0; i < sFull.Length; i++)
            {
                ...
                {
                    int value = isFromDatabase ? LengthDao.GetLength(int.Parse(sCol[j])) : Singleton.Instance.OtherData.Lengths[int.Parse(sCol[j])];
                    lenInfos.Add(new LengthInfo()
                    {
                        ...
                        IDLocation = j,
                        Start = GetStart(i, j),
                        LengthType = Singleton.Instance.OtherData.ShortenOrder.Contains(i + 2) ? LengthType.ResidualImplant : LengthType.Residual,
                        LengthType2 = Singleton.Instance.OtherData.ShortenOrder.Contains(i + 2) ? LengthType.ResidualImplant : LengthType.Residual
                    });
                    if (j == 0) Location1s.Add(Location1s[Location1s.Count - 1] + value - Singleton.Instance.OtherData.DesignInformations[i + 1].DevelopmentLength);
                    else Location2s.Add(Location2s[Location2s.Count - 1] + value - Singleton.Instance.OtherData.DesignInformations[i + 1].DevelopmentLength);
                }
            }
        ...
        private int GetStart(int i, int j)
        {
            if (i == 0)
            {
                return (j == 0 ? Singleton.Instance.OtherData.GeneralInfomation.StartOffset.Offset1 : 
                    Singleton.Instance.OtherData.GeneralInfomation.StartOffset.Offset2) - Singleton.Instance.OtherData.DesignInformations[0].DevelopmentLength;
            }
            return GetIndex(i - 1, j).End - Singleton.Instance.OtherData.DesignInformations[i].DevelopmentLength;
        }
        private void CheckResidual(int i=0)
        {
            ...
            if (i == Singleton.Instance.OtherData.LoopCount - 2)
            {
                if (i == 0)
                {
            ...
            // Column 0 Implanted
            if (Singleton.Instance.OtherData.ShortenOrder.Contains(i + 2))
            {
                ...
                // Column 1 Implanted
                if (Singleton.Instance.OtherData.ShortenOrder.Contains(i + 3))
                {
                ...
                else
                {
                    ...
                    // Different Diameter
                    if (Singleton.Instance.OtherData.DesignInformations[i].Diameter != Singleton.Instance.OtherData.DesignInformations[i + 1].Diameter)
                    {
        ...
        private void SetSingleFit(LengthInfo lenInfo)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.SingleFits.Contains(lenInfo.Value))
                {
        ...
        private void SetDoubleFit(LengthInfo lenInfo1, LengthInfo lenInfo2)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.DoubleFits.Contains(lenInfo1.Value + lenInfo2.Value))
                {
        ...
        private void SetTrippleFit(LengthInfo lenInfo1, LengthInfo lenInfo2, LengthInfo lenInfo3)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.TrippleFits.Contains(lenInfo1.Value + lenInfo2.Value + lenInfo3.Value))
                {
        ...
        private void SetSingleImplant(LengthInfo lenInfo1)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.SingleImplants.Contains(lenInfo1.ImplantValue))
                {
        ...
        private void SetDoubleImplant(LengthInfo lenInfo1, LengthInfo lenInfo2)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.DoubleImplants.Contains(lenInfo1.ImplantValue + lenInfo2.ImplantValue))
                {
        ...
        private void SetDoubleImplantFit(LengthInfo lenInfo1, LengthInfo lenInfo2)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.DoubleFits.Contains(lenInfo1.ImplantValue + lenInfo2.Value))
                {
        ...
        private void SetTripple2ImplantFit(LengthInfo lenInfo1, LengthInfo lenInfo2, LengthInfo lenInfo3)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.TrippleFits.Contains(lenInfo1.ImplantValue + lenInfo2.ImplantValue + lenInfo3.Value))
                {
        ...
        private void SetTrippleImplant2Fit(LengthInfo lenInfo1, LengthInfo lenInfo2, LengthInfo lenInfo3)
        {
            ...
            {
                if (Singleton.Instance.OtherData.FitChosenInformation.TrippleFits.Contains(lenInfo1.ImplantValue + lenInfo2.Value + lenInfo3.Value))
                {
                    lenInfo1.LengthType = LengthType.Tripple2ImplantFit; lenInfo2.LengthType = LengthType.Tripple2ImplantFit; lenInfo3.LengthType = LengthType.Tripple2ImplantFit;
                    lenInfo1.LengthPosition = LengthPosition.First; lenInfo2.LengthPosition = LengthPosition.Second; lenInfo3.LengthPosition = LengthPosition.Third;
                }
