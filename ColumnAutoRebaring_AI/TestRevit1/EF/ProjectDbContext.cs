namespace TestRevit1.EF
{
    ...
    public partial class ProjectDbContext : DbContext
    {
        public ProjectDbContext()
            : base("data source=103.252.252.163;initial catalog=ColumnStandardRebar_AI;persist security info=True;user id=misery;password=Skarner116!;MultipleActiveResultSets=True;App=EntityFramework")
        {
        }
